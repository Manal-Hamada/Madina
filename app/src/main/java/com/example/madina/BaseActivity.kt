...
private fun AlertDialog.Builder.setNegativeButton(postActionName: String?, onCancelListener: DialogInterface.OnCancelListener) {

}

private fun AlertDialog.Builder.setPositiveButton(negatActionName: String?, onCancelListener: DialogInterface.OnCancelListener) {
